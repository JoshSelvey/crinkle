...
def wrangle_teams(teams):
  for team in teams:
    ...
    pd.DataFrame.from_dict(dict_list_to_string(player_to_match_exclusive), orient='index').to_csv(f'Data/Player_to_Match_Exclusive/{team}.csv')
    pd.DataFrame.from_dict(dict_list_to_string(match_to_player_exclusive), orient='index').to_csv(f'Data/Match_to_Player/{team}.csv')
    pd.DataFrame.from_dict(dict_list_to_string(player_to_player_exclusive), orient='index').to_csv(f'Data/Player_to_Player/{team}.csv')
...
def wrangle_world(teams):
  ...
  pd.DataFrame.from_dict(dict_list_to_string(player_to_match), orient='index').to_csv('Data/Player_to_Match_Exclusive/World.csv')
  pd.DataFrame.from_dict(dict_list_to_string(match_to_player), orient='index').to_csv('Data/Match_to_Player/World.csv')
  pd.DataFrame.from_dict(dict_list_to_string(player_to_player), orient='index').to_csv('Data/Player_to_Player/World.csv')
